...
namespace gis_final.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(YasharDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FirstName,LastName,UserNumber,IdentityNumber,PhoneNumber,Email,Password,UserStatus,Id")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
